...
import malfu.wandering_orc.entity.armor.WarriorDiamondArmorRenderer;
...
public final class WarriorDiamondArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private Supplier<Object> renderProvider;

    public WarriorDiamondArmorItem(ArmorMaterial armorMaterial, Type type, Settings properties) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private WarriorDiamondArmorRenderer renderer;
            ...
            public @NotNull BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null) {
                    this.renderer = new WarriorDiamondArmorRenderer();
                }
        ...
        controllers.add(new AnimationController(this, 20, (state) -> {
            ...
            if (entity instanceof ArmorStandEntity) {
                ...
                boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of
                        (ModItems.WARRIOR_DIAMOND_HELMET, ModItems.WARRIOR_DIAMOND_CHESTPLATE,
                                ModItems.WARRIOR_DIAMOND_LEGGINGS, ModItems.WARRIOR_DIAMOND_BOOTS));
