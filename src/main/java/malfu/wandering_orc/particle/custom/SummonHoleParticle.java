...
public class SummonHoleParticle extends SpriteBillboardParticle {
    private final SpriteProvider spriteProvider;

    SummonHoleParticle(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new SummonHoleParticle(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}
